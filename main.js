          ...
          angular.forEach(data.results.bindings, function(val)
              {
                ...
                else
                {
                  ...
                  addMarker({
                    ...
                    //content:'<div style="width: auto; height:auto; position: relative; float: right;"><div style="border-style: dotted; border-width: 1px;"><h1><strong>Name:</strong> '+$scope.finalAttr +'</h1></div><div style="border-style: dotted;border-width: 1px;"><h2><strong>Long:</strong>'+$scope.resLong +'</h2> </div><h2><strong>Lat:</strong>'+$scope.resLat +'</h2></div><div style="border-style: dotted;border-width: 1px;"><h2><strong>Description:</strong> '+$scope.resDescr+'</h2></div><div style="border-style: dotted;border-width: 1px;"><h2></strong>Architect:</strong> '+$scope.finalArchitect+'</h2></div></div>'
                    content:'<div  style="border-style: double;border-color: blue; background-color: lightblue; background-image: linear-gradient(lightblue, 	#1E90FF); width: auto; height:auto; position: relative; float: right;"><div style="border-style: dotted; border-width: 1px;"><h1 <strong>Name:</strong></h1><p>'+$scope.finalAttr +'</p></div><div style="border-style: dotted;border-width: 1px; background-color: lightblue; background-image: linear-gradient(lightblue, 	#1E90FF)"><h2><strong>Long:</strong><h2><p>'+$scope.resLong +'</p></div><h2><strong>Lat:</strong></h2><p>'+$scope.resLat +'</p><div style="border-style: dotted;border-width: 1px; background-color: lightblue; background-image: linear-gradient(lightblue, 	#1E90FF)"><h2><strong>Description:</strong></h2><p>'+$scope.resDescr +'</p></div><div style=" background-size: 250px 100px;border-style: dotted;border-width: 1px; background-color: lightblue; background-image: linear-gradient(lightblue, 	#1E90FF)"><h2> </strong>Architect:</strong></h2><p>'+$scope.finalArchitect +'</p></div></div>'
                  });
              })
      })
      .error(function(error ){
